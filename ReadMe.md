...
> This project uses a Secret Key validation mechanism. Every time `/gitsync` is run, a new UUID is generated and linked specifically to that Telegram Group ID in the database. Webhooks without a matching key/ID will be rejected, done.